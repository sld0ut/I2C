`ifdef ATCIIC100_CONST_VH
`else
	`define ATCIIC100_ID		20'h02021
	`define ATCIIC100_REV_MAJOR	8'h01
	`define ATCIIC100_REV_MINOR	4'h0
	...
	`else
		...
		`else
			...
			`else
			    `ifdef ATCIIC100_FIFO_DEPTH_32
			    	//`define ATCIIC100_INDEX_WIDTH		6
			    	`define ATCIIC100_INDEX_WIDTH		5
			    	`define ATCIIC100_FIFO_CONFIG		3'h4
			    `else
